            ...
            <div className ="about">
                ...
                <Image className="profile" src={Profile}></Image>
                    <div >
                        ...
                        <p>Successfully finishing a full-stack development boot camp with Washington University in St. Louis has shown me that I've barely scratched the surface of what's possible in web development. 
                        I'm very eager to continue learning, to collaborate and help bring ideas to life.</p>
                    </div>
                </Container>
            </div>
        </div>
